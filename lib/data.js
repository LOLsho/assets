...
lib.createSync = util.promisify(lib.create);
...
lib.readSync = util.promisify(lib.read);
...
lib.updateSync = util.promisify(lib.update);
...
lib.deleteSync = util.promisify(lib.delete);
...
lib.listSync = util.promisify(lib.list);
